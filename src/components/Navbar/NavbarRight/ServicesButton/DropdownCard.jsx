export default function DropdownCard({active}) {
    return (
        <div className={`${active ? "visible opacity-100" : "invisible opacity-0"} absolute mt-3 transform bg-white rounded-md shadow-lg translate-x-3/4 min-w-max transition-all duration-200 ease-in-out z-2`}>
